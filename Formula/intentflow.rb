class Intentflow < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      url "https://github.com/rabin-a/intentflow/releases/download/v0.2.0/intentflow-v0.2.0-aarch64-apple-darwin.tar.gz"
      sha256 "8c2647490239d8547d4aab9467a37b1753f29cc35fd92b6b6436fdf5fc5fe5f3"
    else
      url "https://github.com/rabin-a/intentflow/releases/download/v0.2.0/intentflow-v0.2.0-x86_64-apple-darwin.tar.gz"
